...
git add soxl_intraday_trade_log.json soxl_gate_blocks.json soxl_swing_gate_blocks.json tqqq_gate_blocks.json soxl_trade_log.json trade_log.json soxl_earnings_cache.json earnings_cache.json 2>/dev/null
