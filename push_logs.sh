...
git add soxl_intraday_trade_log.json soxl_gate_blocks.json soxl_swing_gate_blocks.json tqqq_gate_blocks.json soxl_trade_log.json trade_log.json soxl_earnings_cache.json earnings_cache.json tqqq_intraday_trade_log.json tqqq_intraday_rejections.jsonl tqqq_intraday_near_miss_outcomes.jsonl tqqq_above_open_trade_log.json 2>/dev/null
