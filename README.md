...
│                               below). No new package needed for
│                               discord.ext.tasks -- ships with discord.py.
...
└── tqqq_ladder_bot/             ← separate tool, see its own dedicated
    ...
    ├── event_flags.py            ← copy of the repo-root version, needed
    │                              locally since this bot runs from its
    │                              own subfolder
    ...
    ├── .env                       ← gitignored (DISCORD_BOT_TOKEN,
    │                                 DISCORD_ALERT_CHANNEL_ID, etc.)
    └── venv/                      ← gitignored, dedicated virtual env
```

---

*Last updated: September 2026 (Session 2) — Ladder bot: built position
